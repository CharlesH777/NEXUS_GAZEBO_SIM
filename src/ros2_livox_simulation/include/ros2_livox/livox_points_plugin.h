...
namespace gazebo
{
   ...
   {
      int ray_index;
      uint32_t scan_sample_index;
      AviaRotateInfo rotate_info;
   };
   ...
   private:
      void InitializeRays(std::vector<RaySample> &points_pair,
      ...
      uint32_t scanLineCount = 1;
      double scanPeriodNs = 100000000.0;
