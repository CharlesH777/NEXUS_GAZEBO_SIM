...
public:
  ...
  bool SearchforCost(int startX, int startY, int goalX, int goalY, nav_msgs::msg::OccupancyGrid occMap, int width, int height,
                     unsigned char obsthresh, int& pathCost, std::vector<utils_ns::PointInt>& path);
  bool SearchforNearCen(int startX, int startY, int goalX, int goalY, nav_msgs::msg::OccupancyGrid occMap, int width, int height,
                     unsigned char obsthresh, int& pathCost, std::vector<utils_ns::PointInt>& path);
