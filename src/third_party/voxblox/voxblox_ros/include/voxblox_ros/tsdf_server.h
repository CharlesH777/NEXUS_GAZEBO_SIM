...
class TsdfServer {
 public:
  ...
  void insertPointcloud(const sensor_msgs::PointCloud2::SharedPtr& pointcloud);

  void insertFreespacePointcloud(
      const sensor_msgs::PointCloud2::SharedPtr& pointcloud);
 ...
 protected:
   ...
   * resolved.
   */
  std::queue<sensor_msgs::PointCloud2::SharedPtr> pointcloud_queue_;
  std::queue<sensor_msgs::PointCloud2::SharedPtr> freespace_pointcloud_queue_;
