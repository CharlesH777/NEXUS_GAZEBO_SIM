...
export MAP_SIM_FASTLIO2_BIN="${MAP_SIM_FASTLIO2_BIN:-$ROOT_DIR/third_party/FASTLIO2_ROS2/install_nexus/fastlio2/lib/fastlio2/lio_node}"
...
export MAP_SIM_FASTLIO2_RVIZ_CONFIG="${MAP_SIM_FASTLIO2_RVIZ_CONFIG:-$ROOT_DIR/third_party/FASTLIO2_ROS2/fastlio2/rviz/fastlio2.rviz}"
