...
Therefore, by subscribing to the `CustomMsg` message, you can consume Livox-style simulated lidar data in your own stack.
...
- [PB_RMSimulation](https://github.com/LihanChen2004/PB_RMSimulation)
    ...
    You can use it as a reference for attaching the robot and world assets in Gazebo.
